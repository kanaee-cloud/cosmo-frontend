...
export const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-primary p-4 md:p-8 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-8 flex-1 relative z-10">
        ...
        <aside className="w-full lg:w-56 flex-shrink-0 flex flex-col gap-3">
          <Link to="/dashboard/home">
            <div className={`flex items-center gap-3 p-4 border transition-all duration-300 ${location.pathname === '/dashboard/home' || location.pathname === '/dashboard' ? 'border-cyan-400 bg-cyan-900/20 text-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.2)]' : 'border-light/50 bg-primary/50 text-gray-500 hover:border-cyan-400/50 hover:text-cyan-400/80'}`}>
          ...
          <Link to="/dashboard/raid-deck">
            <div className={`flex items-center gap-3 p-4 border transition-all duration-300 ${location.pathname === '/dashboard/raid-deck' ? 'border-red-500 bg-red-900/20 text-red-500 shadow-[0_0_15px_rgba(239,68,68,0.2)]' : 'border-light/50 bg-primary/50 text-gray-500 hover:border-red-500/50 hover:text-red-500/80'}`}>
              <Skull size={18} />
