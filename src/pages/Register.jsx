          ...
          {({ values }) => (
            <Form className="space-y-4">
              ...
              <div>
                ...
                <Field type="password" name="password" placeholder="••••••••" className="w-full bg-transparent border border-[#3d2278]/80 text-white font-secondary text-[10px] tracking-wider px-4 py-3 outline-none focus:border-light/70 focus:shadow-[0_0_12px_rgba(138,109,252,0.25)] placeholder:text-gray-600 transition-all duration-200" />
              </div>
              ...
              <div>
                ...
                <Field type="password" name="confirmPassword" placeholder="••••••••" className="w-full bg-transparent border border-[#3d2278]/80 text-white font-secondary text-[10px] tracking-wider px-4 py-3 outline-none focus:border-light/70 focus:shadow-[0_0_12px_rgba(138,109,252,0.25)] placeholder:text-gray-600 transition-all duration-200" />
              </div>

              <button
                type="submit"
                disabled={registerMutation.isPending} // Menggunakan TanStack isPending
                className="w-full bg-accent/30 border border-accent text-accent hover:text-white font-primary text-[10px] tracking-[0.25em] py-3.5 hover:bg-[#cc0044] disabled:opacity-50 disabled:hover:bg-accent/30 transition-all duration-300 active:scale-[0.98] mt-1"
              >
