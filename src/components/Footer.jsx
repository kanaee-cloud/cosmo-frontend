...
const Footer = () => {
    return (
        <motion.footer
            ...
            className="relative overflow-hidden border-t-2 border-secondary pt-12 pb-8 px-6 font-tertiary text-sm bg-primary">
            ...
            <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-20">
                <div className="col-span-1 md:col-span-2">
                    ...
                    <div className="bg-secondary border-2 border-light/20 p-4 font-secondary text-xs h-32 overflow-hidden flex flex-col justify-end pixel-corners shadow-[0_0_15px_rgba(0,0,0,0.8)_inset,0_0_4px_rgba(138,109,252,0.15)]">
                        <p className="text-text mb-1">&gt; Loading assets...</p>
                        <p className="text-text mb-1">&gt; Establishing secure link...</p>
                ...
                <div className="flex flex-col gap-3">
                    <h4 className="text-text font-bold mb-3 uppercase border-b-[3px] border-light/50 pb-2 font-press text-[10px] tracking-widest w-fit">Navigation</h4>
                    <a className="text-text hover:text-light transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#mission">
                        <span className="opacity-0 group-hover:opacity-100 transition-opacity text-light">&gt;</span> Mission Control
                    </a>
                    <a className="text-text hover:text-light transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#armory">
                        <span className="opacity-0 group-hover:opacity-100 transition-opacity text-light">&gt;</span> The Armory
                    </a>
                    <a className="text-text hover:text-light transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#logs">
                        <span className="opacity-0 group-hover:opacity-100 transition-opacity text-light">&gt;</span> Flight Logs
                    </a>
                </div>

                <div className="flex flex-col gap-3">
                    <h4 className="text-text font-bold mb-3 uppercase border-b-[3px] border-light/50 pb-2 font-press text-[10px] tracking-widest w-fit">Protocols</h4>
                    <a className="text-text hover:text-accent transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#privacy">
                        <span className="opacity-0 group-hover:opacity-100 transition-opacity text-accent">&gt;</span> Privacy Policy
                    </a>
                    <a className="text-text hover:text-accent transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#terms">
                        <span className="opacity-0 group-hover:opacity-100 transition-opacity text-accent">&gt;</span> Terms of Service
                    </a>
                    <a className="text-text hover:text-accent transition-colors flex items-center gap-2 group text-xs tracking-wider font-primary" href="#contact">
